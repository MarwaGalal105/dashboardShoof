  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form method="POST" action="{{ url('/dashboard/categories/'.$data->id) }}" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="name" name="name" value="{{$data->name}}" required class="form-control col-md-7 col-xs-12">
            </div>
          </div>
