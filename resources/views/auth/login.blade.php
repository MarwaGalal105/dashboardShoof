				...
				<div class="col-sm-12 col-md-6 col-lg-3">
					<div class="row ulockd-appointment-form-one">
                        ...
                        <form id="lost_form"  class="lost_form_one" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" data-parsley-validate="" novalidate="">
							...
							<div class="form-group">
								<div class="col-md-12 col-sm-6 col-xs-12">
								  <input type="text" id="name" value="{{ old('name') }}"  placeholder="اسم المفقود" required class="form-control required datepicker hasDatepicker">
								</div>
							  </div>
							  ...
							  <div class="form-group">
								<div class="col-md-12 col-sm-6 col-xs-12">
								  <input type="text" id="address"  value="{{ old('address') }}"  placeholder="العنوان" required class="form-control required datepicker hasDatepicker">
								</div>
							  </div>
							 ...
							 <div class="form-group">
							  ...
							  <div class="form-group">
								<div class="col-md-12 col-sm-6 col-xs-12">
								  <input type="number" id="age"  value="{{ old('age') }}"  placeholder="العمر" required class="form-control required datepicker hasDatepicker">
								</div>
							  </div>
					
							  <div class="form-group">
								<div class="col-md-12 col-sm-6 col-xs-12">
								  <input type="date" id="date"  value="{{ old('date') }}"  placeholder="التاريخ" required class="form-control required datepicker hasDatepicker">
								</div>
							  </div>
							  ...
							  <div class="form-group">
								<div class="col-md-12 col-sm-6 col-xs-12">
								  <input type="number" id="telephone"   placeholder="رقم التليفون" value="{{ old('telephone') }}" required class="form-control required datepicker hasDatepicker">
								</div>
							  </div>
