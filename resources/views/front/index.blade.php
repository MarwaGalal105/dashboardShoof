					...
					<div class="about-slider text-right">
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/about/pic10.jpg" alt="pic10.jpg">
								</div>
						...
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/about/pic11.jpg" alt="pic11.jpg">
								</div>
								<div class="ab-details2">
						...
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/about/pic12.jpg" alt="pic12.jpg">
								</div>
								<div class="ab-details2">
						...
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/about/pic15.jpg" alt="pic15.jpg">
								</div>
								<div class="ab-details2">
				...
				<div class="fs_slider">
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic15.jpg" alt="pic15.jpg">
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic4.jpg" alt="pic4.jpg">
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic12.jpg" alt="pic12.jpg">
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic9.jpg" alt="pic9.jpg">
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic10.jpg" alt="pic10.jpg">
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic14.jpg" alt="pic14.jpg">
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic11.jpg" alt="pic11.jpg">
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/fservice/pic8.jpg" alt="pic8.jpg">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/team/pic1.jpg" alt="pic1.jpg">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/team/pic2.jpg" alt="pic2.jpg">
							<div class="ulockd-tm-overlay text-center">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/team/pic3.jpg" alt="pic3.jpg">
							<div class="ulockd-tm-overlay text-center">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="{{url('/')}}/public/front/images/team/pic4.jpg" alt="pic4.jpg">
							<div class="ulockd-tm-overlay text-center">
