        ...
        <div class="header-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="ulockd-welcm-ht text-center">
                            <p class="ulockd-welcntxt"> مرحبا بك! </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="ulockd-welcm-ht text-right">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <form class="ulockd-reg-form text-center" method="POST" action="{{ route('register') }}">
                                                            <h3> <span class="flaticon-house-key"></span> تسجيل </h3>
                                                            @csrf
                                                            <div class="form-group">
                                                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="الاسم" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                                                ...
                                                                <div class="form-group">
                                                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="البريد الالكتروني" value="{{ old('email') }}" required autocomplete="email">
                                                            ...
                                                            <div class="form-group">
                                                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="الرقم السري" name="password" required autocomplete="new-password">
                                                                ...
                                                                <div class="form-group">
                                                                    <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="اعاده الرقم السري" required autocomplete="new-password">
                                                                </div>
                                                            ...
                                                            <div class="form-group text-center">
                                                                    ...
                                                                    <button type="submit" class="btn btn-default ulockd-btn-styledark">
                                                                        {{ __('تسجيل حساب جديد') }}
                                                                    </button>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-lg-3 col-lg-3">
                <div class="ulockd-welcm-hmddl">
                <a href="{{ url('/') }}" class="ulockd-main-logo"><img src="{{url('/')}}/public/front/images/header-logo.png" alt=""></a>
                </div>
        </div>
        @endif
    </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbar-menu">
                                <ul class="nav navbar-nav navbar-right" data-in="fadeIn">
                                    ...
                                    <li >
                                        ...
                                        @else 
                                        <a href="{{ url('/') }}" class="dropdown-toggle" data-toggle="dropdown">الرئيسيه</a>
                                        @endif
...
<a class="scrollToHome" href="{{ url('/home') }}"><i class="fa fa-home"></i></a>
</div>
<!-- Wrapper End -->
<script>
        function myFunction() {
          alert("من فضلك قم بتسجيل الدخول");
        }
        </script>
