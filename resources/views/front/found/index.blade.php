                ...
                <div class="col-md-12">
                    <div class="ulockd-icd-layer">
                        <ul class="list-inline ulockd-icd-sub-menu">
                                ...
                                <li><a href="#"> > </a></li>
                                <li> <a href="{{ url('findchild') }}">تم العثور عليهم </a> </li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3 clearfix" >
                                 <div class="ulockd-shop-item">
                                    ...
                                    <div class="ulockd-product-details">
                                        ...
                                        <h3>{{ $data->name }}</h3>
                                        <p>{{ $data->notes }}</p>
                                        <a class="btn btn-lg ulockd-btn-styledark hvr-bounce-to-right" href="{{ url('findchild/'.$data->id) }}">قراءه المزيد</a>
                                    </div>
                                    </div>
                            </div>
                            @endif                        
                        ...
                        <div class="ulockd-latest-post">
                            <div class="media">
                                ...
                                <div class="media-body">
                                   ...
                                   {{$data->notes}} <a href="{{ url('findchild/'.$data->id) }}"> <strong class="text-thm"> المزيد... </strong> </a>
