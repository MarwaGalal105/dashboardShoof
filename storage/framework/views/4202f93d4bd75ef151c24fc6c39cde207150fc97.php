...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
  <br>
  <form method="POST" action="<?php echo e(Route('options.store')); ?>" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoofToday\resources\views/dashboard/options/create.blade.php ENDPATH**/ ?>