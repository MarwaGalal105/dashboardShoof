        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title">
              <a href="<?php echo e(url('dashboard/')); ?>" class="site_title"><i class='fa fa-camera' ></i><span>App dashboard</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo e(url('dashboard/')); ?>"><i class='fa fa-home' ></i> Dashboard</span></a> </li>

                  <li><a href="<?php echo e(url('dashboard/categories/')); ?>"><i class="fa fa-object-group"></i></i>Categories</span></a> </li>

                  <li><a href="<?php echo e(url('dashboard/info/')); ?>"><i class="fa fa-info-circle"></i>Data</span></a> </li>
              ...
              <div class="menu_section">
                  ...
                  <ul class="nav side-menu">                 
                    <li><a href="<?php echo e(url('dashboard/options/')); ?>"><i class="fa fa-edit"></i> Options</span></a> </li>
                                 
                  <li>
                    <a href="<?php echo e(url('dashboard/users/')); ?>"><i class="fa fa-user"></i> Users </a>
                   
                    </li>

                     <li>
                    <a href="<?php echo e(url('dashboard/cities/')); ?>"><i class="fa fa-map-marker"></i> Cities </a>
...
<?php /**PATH C:\xampp\htdocs\ShoofToday\resources\views/dashboard/layouts/main.blade.php ENDPATH**/ ?>