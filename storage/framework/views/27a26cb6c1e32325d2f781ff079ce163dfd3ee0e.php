			...
			<div class="row">
					...
					<div class="about-slider text-right">
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/about/pic10.jpg" alt="pic10.jpg">
								</div>
						...
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/about/pic11.jpg" alt="pic11.jpg">
								</div>
								<div class="ab-details2">
									<h4 class="text-thm"> 24h/7days Care</h4>
									<p>Day in and day out Nursing and Medial Services gives custom-made care to personally in their cabin who are attempting to oversee all alone</p>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/about/pic12.jpg" alt="pic12.jpg">
								</div>
								<div class="ab-details2">
						...
						<div class="item">
							<div class="about-box2">
								<div class="ab-thumb">
									<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/about/pic15.jpg" alt="pic15.jpg">
								</div>
								<div class="ab-details2">
				...
				<div class="col-sm-12 col-md-6 col-lg-3">
					<div class="row ulockd-appointment-form-one">
	                    ...
	                    <form id="appointment_form" name="appointment_form" class="appointment_form_one" action="#" method="post" novalidate="novalidate">
	                        <div class="messages"></div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
								<h2 class="text-thm">الابلاغ عن طفل</h2>
								<p>ساعدنا نلاقي طفلك</p>
                                <div class="form-group text-right">
                                    <input id="form_name" name="form_name" class="form-control" placeholder="الاسم" required="required" data-error="Name is required." type="text">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group text-right">
                                    <input id="form_email" name="form_email" class="form-control required email" placeholder="البريد الالكتروني" required="required" data-error="Email is required." type="email">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group text-right">
                                    <input id="form_date" name="form_date" class="form-control required datepicker" placeholder="التاريخ" required="required" data-error="Subject is required." type="text">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group text-right">
                                    <input id="form_phone" name="form_phone" class="form-control required" placeholder="رقم التليفون" required="required" data-error="Phone Number is required." type="text">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
		                        <div class="form-group text-right">
		                            <textarea id="form_message" name="form_message" class="form-control required" rows="3" placeholder="ملاحظات" required="required" data-error="Message is required."></textarea>
		                            <div class="help-block with-errors"></div>
		                        </div>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center">
					<div class="ulockd-dtitle hvr-float-shadow">
						<h2 id="C2" class="text-uppercase"> <span class="text-thm">اطفال تم العثور عليها</span></h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="fs_slider">
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic15.jpg" alt="pic15.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-minibus"></span></div>
							</div>
							<div class="db-details">
								<h4>Transportation Facilities</h4>
								<p>There are various sorts of transportation offices that we can fabricate and work to fulfill our day by day travel needs.Comfort home provide also transport facilities</p>
					...
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic4.jpg" alt="pic4.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-nurse-1"></span></div>
							</div>
							<div class="db-details">
								<h4>Experienced Nurse</h4>
								<p>As a basic part of nursing practice, clinical thinking is utilized to absorb data, investigate information, and settle on choices with respect to patient care</p>
								<button type="submit" class="btn btn-default ulockd-btn-thm">قراءه المزيد</button>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic12.jpg" alt="pic12.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-laundry"></span></div>
							</div>
							<div class="db-details">
								<h4>Laundry Facilities</h4>
								<p>Business, institutional and modern clothing offices clean extensive amounts of textures in an extensive variety of assortments and employments</p>
								<button type="submit" class="btn btn-default ulockd-btn-thm">قراءه المزيد</button>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic9.jpg" alt="pic9.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-books-piled"></span></div>
							</div>
							<div class="db-details">
								<h4>Library Facilities</h4>
								<p>The Institute Library is open get to and current material is promptly accessible. The advance times of books fluctuate as per their interest for instructing Lorem ipsum</p>
								<button type="submit" class="btn btn-default ulockd-btn-thm">قراءه المزيد</button>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic10.jpg" alt="pic10.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-phonendoscope"></span></div>
							</div>
							<div class="db-details">
								<h4>Schedule Checkup</h4>
								<p>Customary wellbeing exams and tests can help discover issues before they begin. They likewise can help discover issues early, your odds for treatment, cure are better</p>
								<button type="submit" class="btn btn-default ulockd-btn-thm">قراءه المزيد</button>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic14.jpg" alt="pic14.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-woman-hair"></span></div>
							</div>
							<div class="db-details">
								<h4>Beauty/Barbar Facilities</h4>
								<p>No longer do you or your occupants need to secure hair arrangements off-site and organize transportation. Our beauticians come to you at your area and in our comfort home</p>
								<button type="submit" class="btn btn-default ulockd-btn-thm">قراءه المزيد</button>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic11.jpg" alt="pic11.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-exercise"></span></div>
							</div>
							<div class="db-details">
								<h4>Fitness Programs</h4>
								<p>In case you're similar to the vast majority, you invest an abundant excess energy taking a seat, which has been appeared to have negative wellbeing results</p>
								<button type="submit" class="btn btn-default ulockd-btn-thm">قراءه المزيد</button>
							</div>
						</div>
					</div>
					<div class="item">
						<div class="ulockd-fservice-box text-right hvr-float-shadow">
							<div class="db-thumb">
								<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/fservice/pic8.jpg" alt="pic8.jpg">
								<div class="db-overlayer"><span title="Feature Service Icon" class="flaticon-garlands"></span></div>
							</div>
							<div class="db-details">
								<h4>Festival Event</h4>
								<p>The World Culture Festival 2017 is a festival of The Art of Living's 25 years of administration, humankind, deep sense of being and human qualities that was awesome</p>
								<button type="submit" class="btn btn-default ulockd-btn-thm">قراءه المزيد</button>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-sm-7 col-md-6 col-lg-3">
					<div class="ulockd-ffact-one">
						<span class="ulockd-icon-let flaticon-trophy-for-sports pull-right"></span>
				...
				<div class="col-sm-7 col-md-6 col-lg-3">
					<div class="ulockd-ffact-one">
						<span class="ulockd-icon-let flaticon-medal pull-right"></span>
                        <p>اطفال تم العثور عليها</p>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center">
					<div class="ulockd-team-title hvr-float-shadow">
						<h2 id="C1" class="text-uppercase">اطفال <span class="text-thm">مفقوده</span></h2>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/team/pic1.jpg" alt="pic1.jpg">
							<div class="ulockd-tm-overlay text-center">
								<div class="ulockd-tm-name">Henry Jones</div>
								
								<a href="page-team-details.html"> More Details..</a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/team/pic2.jpg" alt="pic2.jpg">
							<div class="ulockd-tm-overlay text-center">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/team/pic3.jpg" alt="pic3.jpg">
							<div class="ulockd-tm-overlay text-center">
								<div class="ulockd-tm-name">Williams Jones</div>
								<a href="page-team-details.html"> More Details..</a>
							</div>
						</div>
						<div class="ulockd-tm-details"></div>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
					<div class="ulockd-team-member">
						<div class="ulockd-tm-thumb">
							<img class="img-responsive img-whp" src="<?php echo e(url('/')); ?>/public/front/images/team/pic4.jpg" alt="pic4.jpg">
							<div class="ulockd-tm-overlay text-center">
...
<?php echo $__env->make('front.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoofToday\resources\views/front/index.blade.php ENDPATH**/ ?>