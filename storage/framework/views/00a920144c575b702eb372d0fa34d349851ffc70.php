...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form method="POST" action="<?php echo e(url('dashboard/info/'.$info->id)); ?>" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
  ...
  <div class="form-group">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        <textarea name="notes" id="notes" value="<?php echo e($info->notes); ?>" required="required" class="form-control col-md-7 col-xs-12"></textarea>
        </div>
    </div>
 ...
 <div class="form-group">
    ...
    <div class="form-group" >
      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" style="margin-top:20px">
        <button class="btn btn-primary"  type="button"><a href="<?php echo e(url('/')); ?>/dashboard/info" style="color:white">Cancel</a></button>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\ShoofToday\resources\views/dashboard/info/edit.blade.php ENDPATH**/ ?>