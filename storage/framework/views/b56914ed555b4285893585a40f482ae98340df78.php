    ...
    <div class="container text-center">
        <div class="row">
            <div class="ulockd-inner-conraimer-details">
                <div class="col-md-12">
                    <h1 class="text-uppercase">تم العثور عليهم</h1>
                </div>
                <div class="col-md-12">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-lg-9">
             ...
             <form action="<?php echo e(route('searchfound')); ?>">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3 clearfix" >
                                 <div class="ulockd-shop-item">
                                    ...
                                    <div class="ulockd-product-details">
                                        ...
                                        <a class="btn btn-lg ulockd-btn-styledark hvr-bounce-to-right" href="<?php echo e(url('findchild/'.$data->id)); ?>">قراءه المزيد</a>
                                    </div>
                                    </div>
                            </div>
                            <?php endif; ?>                        
        ...
        <div class="col-md-4 col-lg-3 ulockd-pad-zero pad15-xs">
            ...
            <h3 class="ulockd-bb-dashed"><span class="flaticon-calendar text-thm"></span> تم العثور عليهم</h3>
            <div class="ulockd-lp">
...
<?php echo $__env->make('front.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\ShoofToday\resources\views/front/found/index.blade.php ENDPATH**/ ?>