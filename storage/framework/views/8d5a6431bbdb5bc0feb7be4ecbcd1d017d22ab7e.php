...
if (isset($messageCache)) { $message = $messageCache; }
                                                        ...
                                                        <form class="ulockd-reg-form text-center" method="POST" action="<?php echo e(route('register')); ?>">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="الاسم" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="email" placeholder="البريد الالكتروني" value="<?php echo e(old('email')); ?>" required autocomplete="email">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" placeholder="الرقم السري" name="password" required autocomplete="new-password">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-lg-3 col-lg-3">
                <div class="ulockd-welcm-hmddl">
                <a href="<?php echo e(url('/')); ?>" class="ulockd-main-logo"><img src="<?php echo e(url('/')); ?>/public/front/images/header-logo.png" alt=""></a>
                </div>
        </div>
        <?php endif; ?>
    </div>
                        ...
                        <div class="container ulockd-padd90">
                            ...
                            <div class="collapse navbar-collapse" id="navbar-menu">
                                <ul class="nav navbar-nav navbar-right" data-in="fadeIn">
                                    ...
                                    <li>
                                        <a href="<?php echo e(url('/contact')); ?>" class="dropdown-toggle" data-toggle="dropdown">اتصل بنا</a>
                                    ...
                                    <li >
                                        ...
                                        <?php else: ?> 
                                        <a href="<?php echo e(url('/')); ?>" class="dropdown-toggle" data-toggle="dropdown">الرئيسيه</a>
                                        <?php endif; ?>
...
<a class="scrollToHome" href="<?php echo e(url('/home')); ?>"><i class="fa fa-home"></i></a>
</div>
<!-- Wrapper End -->
<script>
        function myFunction() {
