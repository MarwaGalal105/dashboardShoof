                  ...
                  <div class="x_content">
                    ...
                    <form method="POST" action="<?php echo e(route('offers.store')); ?>"  enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12" style="padding-left:0px">
                          <input type="text" name="offer_post" id="offer_post" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\firstapp\resources\views/offers/create.blade.php ENDPATH**/ ?>