                  ...
                  <div class="x_content">
                    ...
                    <input name="_method" type="hidden" value="PUT">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="department" id="department" value="<?php echo e($users->department); ?>"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\firstapp\resources\views/users/edit.blade.php ENDPATH**/ ?>