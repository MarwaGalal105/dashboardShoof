        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo e(url('/')); ?>" class="site_title"><i class="fa fa-paw"></i> <span>App dashboard</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo e(url('/')); ?>"><i class='fa fa-camera' ></i> Dashboard</span></a> </li>

                  <li><a href="<?php echo e(url('categories/')); ?>"><i class="fa fa-object-group"></i></i>Categories</span></a> </li>
                  <li><a href="<?php echo e(url('offers/')); ?>"><i class="fa fa-table"></i> Offers</span></a> </li>
...
<?php /**PATH C:\xampp\htdocs\firstapp\resources\views/layouts/main.blade.php ENDPATH**/ ?>