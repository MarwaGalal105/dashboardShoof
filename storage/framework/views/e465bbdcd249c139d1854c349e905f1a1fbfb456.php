            ...
            <div class="col-sm-12 col-md-5 col-md-offset-3">
              <div class="booking_form_style1 text-center">
                <form id="booking_form" class="booking_form text-center" name="booking_form" action="<?php echo e(Route('findchild.store')); ?>" method="POST"  enctype="multipart/form-data"  accept-charset="utf-8">
                  ...
                  <div class="row">
                      <div class="col-sm-12">
                          <h3>اضف بيانات الطفل الذي تم العثور عليه</h3>
                      </div>
                      <div class="col-sm-12">
...
<?php echo $__env->make('front.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\ShoofToday\resources\views/front/findchild.blade.php ENDPATH**/ ?>