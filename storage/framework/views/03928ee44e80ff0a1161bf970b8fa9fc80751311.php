...
<div class="x_content">
  <br>
  <form method="POST" action="<?php echo e(url('dashboard/users/'.$users->id)); ?>" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
...
<div class="form-group">
  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
    <button class="btn btn-primary" type="button"><a href="<?php echo e(url('/')); ?>/dashboard/users" style="color:white">Cancel</a></button>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp\www\ShoofToday\resources\views/dashboard/users/edit.blade.php ENDPATH**/ ?>