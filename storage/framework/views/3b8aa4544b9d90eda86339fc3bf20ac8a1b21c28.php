            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo e(url('info/')); ?>"><i class="fa fa-info-circle"></i>Data</span></a> </li>
              ...
              <div class="menu_section">
                  ...
                  <li>
                    <a href="<?php echo e(url('users/')); ?>"><i class="fa fa-user"></i> Users </a>
                     ...
                     <li>
                    <a href="<?php echo e(url('cities/')); ?>"><i class="fa fa-map-marker"></i> Cities </a>
...
<?php /**PATH C:\xampp\htdocs\ShoofToday\resources\views/layouts/main.blade.php ENDPATH**/ ?>