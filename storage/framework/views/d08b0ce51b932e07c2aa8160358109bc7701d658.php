        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="notes" name="notes" value="<?php echo e(old('notes')); ?>" required class="form-control col-md-7 col-xs-12">
            </div>
          </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ShoofToday\resources\views/info/create.blade.php ENDPATH**/ ?>